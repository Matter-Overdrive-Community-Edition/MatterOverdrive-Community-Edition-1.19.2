...
public class SlotShielding extends SlotGeneric {

	@Nullable
	private Item[] validItems;

	public SlotShielding(CapabilityInventory inventory, int index, int x, int y, int[] screenNumbers, SlotType type,
