...
public enum OverdriveBlockColors implements IBulkRegistryObject {
	...
	BLACK(30, 30, 30, 1), BLUE(0, 0, 255, 1), BROWN(139, 69, 19, 1), CYAN(0, 255, 255, 1), GRAY(169, 169, 169, 1),
	GREEN(0, 128, 0, 1), LIGHT_BLUE(135, 206, 250, 1), LIGHT_GRAY(211, 211, 211, 1), LIME(0, 255, 0, 1),
