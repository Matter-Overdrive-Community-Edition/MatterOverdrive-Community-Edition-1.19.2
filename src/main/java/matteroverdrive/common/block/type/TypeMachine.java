...
public enum TypeMachine {
	...
	HOLO_SIGN(new VoxelShape[] { Shapes.box(0.0D, 0.6875D, 0.0D, 1.0D, 1.0D, 1.0D),
		...
		Shapes.box(0.0D, 0.0D, 0.0D, 1.0D, 1.0D, 0.3125D), Shapes.box(0.6875D, 0.0D, 0.0D, 1.0D, 1.0D, 1.0D),
		Shapes.box(0.0D, 0.0D, 0.0D, 0.3125D, 1.0D, 1.0D) },
		OverdriveBlockProperties.from(GenericMachineBlock.DEFAULT_MACHINE_PROPERTIES).setHasFacing(false)),
	...
	STAR_MAP(Shapes.box(0.0D, 0.0D, 0.0D, 1.0D, 1.0D, 1.0D),
					OverdriveBlockProperties.from(GenericMachineBlock.DEFAULT_MACHINE_PROPERTIES).setHasFacing(true)),
	WEAPON_STATION(Shapes.box(0.0D, 0.0D, 0.0D, 1.0D, 1.0D, 1.0D),
					OverdriveBlockProperties.from(GenericMachineBlock.DEFAULT_MACHINE_PROPERTIES).setHasFacing(true));
